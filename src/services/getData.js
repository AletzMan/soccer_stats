...
const API_URL_RESULTS = 'https://www.univision.com/proxy/api/cached/sports/v1/schedule-results/soccer?seasonKey=2022&competitionKey=385&sort=start-date-time-asc&limit=50&startDate=2023-03-10T07%3A00%3A00.000Z';
...
export const getResultsDay = async () => {
    try {
        ...
        const data = await response.json();
        const response2 = await fetch(`${API_URL_RESULTS}`)
